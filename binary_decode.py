...
def decode_hex_string(hex_string):
    ...
    groups = ['log_type', 'can_bus_number', 'violation_rule_id', 'signal_start_bit', 'signal_length', 'raw_message_length', 'message_can_id', 'detection_time', 'detection_reason', 'duplication_number', 'reserved', 'raw_message_body']
    results = {}
